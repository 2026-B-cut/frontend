...
export function MainHeader({ onLayout, onOpenProfile, profileEmoji, profileImageUrl, topInset }: MainHeaderProps) {
  const profileTarget = useTutorialTarget('profile-header', { offsetY: 27 });

  return (
    <View onLayout={onLayout} style={[styles.header, { paddingTop: topInset }]}>
